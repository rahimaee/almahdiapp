...
def import_feature(request):
    features = [
        ...
        'ایجاد دوره عقیدتی',
        'ویرایش دوره عقیدتی',
        'لیست سربازان و دوره عقیدتی',
        'لیست سربازانی که دوره عقیدتی ندارند',
        'آپلود فایل اکسل دوره عقیدتی',
        'تخصیص دوره عقیدتی به فرد',
        'لیست گروه‌های ناصرین',
        'ایجاد گروه ناصرین',
        'ویرایش گروه ناصرین',
        'جدول افراد و گروه های ناصرین',
        'ویرایش گروه ناصرین سربازان',
        'تخصیص گروه ناصرین به سربازان فاقد گروهی',
    ]
