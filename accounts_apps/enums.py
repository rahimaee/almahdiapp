...
class AccountingRole(Enum):
    ...
    NIRU_ENSAN_KARGOZINI_RASMI = (102, "فرمانده کارگزینی رسمی")
    NIRU_ENSAN_GHADAEI = (103, "فرمانده قضایی")

    # قرارگاه (200–299)
    GHARARGAH_FARMANDE = (200, "فرمانده گردان قرارگاه")
    GHARARGAH_FIZIKI = (201, "فرمانده فیزیکی")
    GHARARGAH_JANESHIN = (202, "جانشین فرمانده قرارگاه")
    GHARARGAH_DEZBANI = (203, "فرمانده دژبانی")
